 ...
 */
public class ProjectRepositoryIntegrationTest extends BaseTestNG{
    ...
    @Test
    public void getProjectByIdSuccessResponse() throws Exception {
        Project project = projectRepository.findById(testProject.getId());
        assertNotNull(project);
        assertNotNull(project.getId());
        assertNotNull(project.getPlannedBudget());
     ...
     */
    @Test
    public void getProjectByIdErrorResponse() throws Exception {
        String projectId = "-91";
    ...
    public void cleanup() throws Exception{
        //find a way to delete only the data setup by this test
